package com.example.nm_gql_go_link;
...
/** NmGqlGoLinkPlugin */
public class NmGqlGoLinkPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "nm_gql_go_link");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    } else if (call.method.equals("getGoVersion")) {
      try {
        result.success(Nmgql.getGoVersion());
      } catch (Exception e) {
