# Copied from: https://raw.githubusercontent.com/NixOS/nixpkgs/42e09c2134add3ae66c6579478c474aeffd8443d/pkgs/development/interpreters/dart/default.nix
{ stdenv, fetchurl, unzip, version ? "2.10.0" }:
